...
const popularCities = [
    { name: 'Delhi', fullName: 'Delhi ISBT Kashmiri Gate' },
    { name: 'Mumbai', fullName: 'Mumbai Central Bus Station' },
    { name: 'Bangalore', fullName: 'Majestic Bus Station' },
    { name: 'Hyderabad', fullName: 'MGBS Bus Station' },
    { name: 'Chennai', fullName: 'Chennai Mofussil Bus Terminus' },
    { name: 'Kolkata', fullName: 'Esplanade Bus Terminus' },
    { name: 'Ahmedabad', fullName: 'Ahmedabad Central Bus Station' },
    { name: 'Pune', fullName: 'Swargate Bus Station' }
];

const BusSearchForm = ( { onChange, onSearch } ) => {
